...
const HostedPlugin = ({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.SafeAreaView, {
    ...
    children: showWebView && /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
      ...
      Applepay.createApplePayToken("merchant.sa.urwayphp", "1.00", "label", "SA", "SAR", async (err, token) => {
        if (err) {
          ...
          try {
            ...
            _reactNative.Alert.alert('Error', 'Failed to process Apple Pay');
            onClose({
              error: 'Failed to process Apple Pay'
