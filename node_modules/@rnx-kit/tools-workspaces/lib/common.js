...
exports.findPackages = makeFindPackages(fast_glob_1.default, Promise.resolve([]), (result) => result.then(dirnameAll));
exports.findPackagesSync = makeFindPackages(fast_glob_1.default.sync, [], dirnameAll);
...
async function readJSON(path) {
    const json = await (0, promises_1.readFile)(path, { encoding: "utf-8" });
    return JSON.parse((0, strip_json_comments_1.default)(json));
}
